...
ln -sfn /checkpoint/${USER}/${SLURM_JOB_ID} $PWD/benchpush/baselines/area_clearing/sam/checkpoint/${SLURM_JOB_ID}
...
python $PWD/scripts/area_clearing_baselines.py --job_id ${SLURM_JOB_ID} --config_file $PWD/benchpush/environments/area_clearing/config.yaml