...
ln -sfn $SCRATCH/checkpoint/${SLURM_JOB_ID} $PWD/benchpush/baselines/box_delivery_mujoco/SAM/checkpoint/${SLURM_JOB_ID}
...
python $PWD/scripts/box_delivery_mujoco_baselines.py --job_id ${SLURM_JOB_ID} 