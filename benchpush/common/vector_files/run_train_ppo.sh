...
ln -sfn /checkpoint/${USER}/${SLURM_JOB_ID} $PWD/benchpush/baselines/box_delivery/ppo/checkpoint/${SLURM_JOB_ID}
...
python $PWD/tests/box_delivery_baselines.py --job_id ${SLURM_JOB_ID} --config_file $PWD/benchpush/environments/box_delivery/config_ppo.yaml