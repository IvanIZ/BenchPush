    ...
    def __init__(
        ...
        **kwargs,
        ...
        _, self.initialization_keepouts = generate_area_clearing_xml(N=self.cfg.boxes.num_boxes, env_type=self.cfg.env.area_clearing_version, file_name=xml_file,
                        ...
                        wall_clearence_outer=self.cfg.env.wall_clearence_outer, wall_clearence_inner=self.cfg.env.wall_clearence_inner, internal_clearance_length=self.cfg.env.internal_clearance_length, robot_radius= self.robot_radius, bumper_type=self.cfg.env.type_of_bumper)
